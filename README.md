...
Replace the entire cadd process file (specify the correct pipeline version instead of *):
```
cp -b scripts/cadd/main.nf nf-core-raredisease_*/*/modules/nf-core/cadd/main.nf
```
